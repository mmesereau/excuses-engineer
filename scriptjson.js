...
var excuse = [
  "javascript", "php", "ruby", "python", "node", "algorithm", "ASCII", "framework", "garbage collection", "heuristic evaluation", "implicit parallelism", "language processor", "lexical analysis", "middleware", "noncontiguous data structure", "null pointer", "object-oriented programming", "reserved word", "SQL", "subroutine", "transcompiler", "turing completeness", "visual basic", "z-buffer"
]
